...
terraform {
  ...
  backend "azurerm" {
    resource_group_name  = "rg-az-workshop-lll"         # mettre ici le nom du resource group de vos ressource
    storage_account_name = "csazworkshoplll"      # mettre le nom du compte de stockage créer dans le lab 1
